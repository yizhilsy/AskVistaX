...
public class PostController {
    ...
    public Result listPosts(@RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "10") Integer pageSize,
        ...
        PageBean pageBean = postService.listPosts(page, pageSize, postName, postLocation, postBusinessGroup, postType);
        log.info("账号名为: {}的用户: {}分页查询Posts成功, roleType: {}, 参数page: {}, pageSize: {}, postName: {}, postLocation: {}, postBusinessGroup: {}, postType: {}",
                userAccount, userName, CommonConstants.roleTypeMap.get(roleType), page, pageSize, postName, postLocation, postBusinessGroup, postType);
